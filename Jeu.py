...
while jouer_encore:
    ...
    if diplome_obtenu:
        ...
        if info_visa:
            ...
            # =====================================================================
            # 14. SAISON 2 - CHAPITRE 10 : LE PREMIER STAGE (NOUVEAU !)
            # =====================================================================
            print("\n" + "="*50)
            ...
            print("Grâce à ton profil, tu obtiens un entretien Zoom avec le CTO d'une startup locale.")
            
            afficher_dialogue("Recruteur", "Hi Merdi! J'ai vu ton parcours. Dis-moi, si notre base de données Python plante en pleine production à cause d'une surcharge, quelle est ta première réaction technique ?")
            
            print(f"\nTon niveau de compétences actuel : {competences} points.")
            print("1. Proposer d'optimiser les requêtes avec un système de cache (Demande au moins 50 points de compétences).")
            print("2. Dire honnêtement que tu vas analyser les logs d'erreurs pour trouver la ligne exacte qui bloque (+10 points).")
            print("3. Paniquer et couper discrètement ta connexion Internet pour simuler un problème technique.")

            choix_stage = input("\nEntre ton choix (1, 2 ou 3) : ")

            print("\n" + "-"*30)
            print("💼 LE VERDICT DE L'ENTRETIEN 💼")
            print("-"*30)

            if choix_stage == "1":
                if competences >= 50:
                    print("\n🔥 Réponse d'expert ! Le CTO est impressionné par ton bagage technique.")
                    print("Il te dit : 'Welcome team!' Tu décroches le stage payé à 1200 $ par mois !")
                    dollars += 1200
                    competences += 20
                else:
                    print("\n❌ Aïe... Tu t'es emmêlé les pinceaux dans tes explications techniques.")
                    print("Le recruteur a vu que tu manquais de pratique. Le stage te passe sous le nez.")
            elif choix_stage == "2":
                print("\n👍 Une réponse humble et très professionnelle ! Les développeurs adorent la méthode.")
                print("Tu décroches un stage d'assistant technique payé à 600 $ par mois. C'est un super début !")
                dollars += 600
                competences += 15
            else:
                print("\n🤦 Le recruteur a tout de suite compris le coup de la fausse panne.")
                print("Tu es blacklisté de la startup. Tu passeras ton été à réviser tes cours au lieu de travailler.")

            print("\n" + "="*50)
            print("       🏆 FIN DE L'AVENTURE : FIN DE LA SAISON 2 🏆")
            print("="*50)
            print(f"Félicitations ! Tu as terminé la Saison 2 de 'La vie d'un étudiant' !")
            print(f"Stats finales globales -> Code : {competences} | Compte en Dollars : {dollars} $")

                # =====================================================================
            # 16. SAISON 3 - CHAPITRE 12 : LE CHOC DU DÉLESTAGE
            # =====================================================================
            print("\n" + "="*50)
